...
public:
  ...
  static int isObstacleTooClose(sensor_msgs::LaserScan & LaserMsg, int start_index, int end_index, double DistanceThreshold);
  static int isMeasurementReliable(sensor_msgs::LaserScan & LaserMsg, int min_index);
//private:
